...
<html lang="en">
    <head>
    	...
    	<script type="text/javascript">
				...
				function showDialog4() {$("#myresetpass").modal();}
		</script>
    </head>
    <body onload="showDialog4()">
    ...
    <div class="col-sm-2" data-toggle="tooltip" title="click here for offer!"> 
      <div class="panel panel-primary" onclick="loadmodalitem6()">
        ...
        <div class="panel-footer">Coupons are valid for a limited time only. Paytm reserves the right to modify or cancel coupons at any time</div>
			...
			<div class="modal fade" id="myresetpass" tabindex="-1" role="dialog">
				<div class="modal-dialog">
					<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header" style="padding:30px 50px;">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4><span class="glyphicon glyphicon-lock glyphicon-piggy-bank glyphicon-repeat"></span> TopUp your Wallet </h4>
							</div>
							<div class="modal-body" style="padding:40px 50px;">
								<form role="form" method="post" action="RechargeUserAccount">
									
									<div class="form-group">
										<label for="recharge"><span class="glyphicon glyphicon-piggy-bank"></span>Recharge Amount</label>
										<input type="text"  maxlength="5" pattern="[0-9]{2,5}" name="rechargeAmount" class="form-control"  placeholder="Recharge Amount"/><br/>
									</div>
									<button type="submit" class="btn btn-success btn-lg" id="myBtnregister1"><span class="glyphicon glyphicon-off"></span> Update </button>
								</form>
							</div>
						<div class="modal-footer">
							<button type="submit" class="btn btn-danger btn-sm btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
